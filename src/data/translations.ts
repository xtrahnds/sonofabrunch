...
export const NAV_TEXT = {
  ...
  subBrand: '銀髮助理',
  subBrandEn: 'Boutique Bilingual Senior Concierge & Elderly Escort',
...
export const HERO_TEXT = {
  titleEn: 'Autonomous Living, Never Alone | Premier Senior Companion in Vancouver',
  subtitleEn: 'Living overseas and worried about aging parents in Vancouver? Seeking dignified elderly support or senior visit services without making loved ones feel patronized?\n\nAs Vancouver\'s premier bilingual senior concierge, Son Of A Brunch provides a discreet senior companion and driving wellness service. Posing as polite driving instructors offering refresher lessons, we visit your parents on your behalf while subtly assessing their mobility, cognition, and well-being. After each visit, you receive a detailed briefing—giving families remote peace of mind with 100% dignity.',
  titleTc: '獨而不孤、自主生活',
  ...
  taglineEn: 'GREATER VANCOUVER BILINGUAL SENIOR CONCIERGE & ELDERLY ESCORT',
...
export const PHILOSOPHY_TEXT = {
  ...
  badgeTc: '尊嚴守護哲學',
  titleEn: 'Preserving Dignity and Quality of Life with Dedicated Elderly Support',
  titleTc: '替你照顧長者嘅尊嚴與生活質感',
  p1En: 'Living overseas and worried about your aging parents residing in Canada? Looking for senior companion or nursing home visit services, but your elders resist being "cared for" or "inspected"? We provide a unique senior visit & driving status monitoring service. A professional instructor visits under the guise of "refresher driving lessons". Through relaxed interaction, we visit your elders on your behalf while discreetly evaluating their reaction time, memory, and physical mobility. After every visit, we deliver a detailed health and well-being report directly to you, giving you genuine peace of mind from afar.',
  ...
  p1aEn: 'Living overseas and worried about your aging parents residing in Canada? Looking for a senior companion or family visit service, but your elders resist being "cared for"?',
  p1aTc: '身喺香港，擔心留在加拿大的父母？想搵代探病或代探老人院服務，但老人家又排斥被『照顧』或『檢查』？',
  p1bEn: 'We provide a unique senior companion & driving status monitoring service. A professional instructor visits under the guise of "refresher driving lessons". Through relaxed interaction, we visit your elders on your behalf while discreetly evaluating their reaction time, memory, mental state, and physical mobility. After every session, we deliver a detailed health and mental well-being report directly to you overseas, giving you genuine peace of mind from afar.',
  ...
  krisTitleEn: 'Attentive Senior Companion & Active Listening',
  krisTitleTc: '傾聽者與貼心隨行',
  krisDescEn: 'Seniors are living encyclopedias of wisdom who deserve high-touch respect. Beyond luxury chauffeur transportation, lifestyle elderly support, and bilingual medical escort translation, our core strength is active listening. Through warm, organic conversation, we identify home maintenance needs or physical discomforts, recording and reporting them to you in real time.',
  ...
  boundaryNoticeEn: 'Dignity-First Boundary: Premium bilingual senior concierge & driving companion. (Explicitly non-medical; excludes personal hygiene, bathing, or invasive nursing procedures).',
...
export const SERVICES_DATA: ServiceItem[] = [
  {
    id: 'driving-escort',
    iconName: 'Car',
    titleEn: 'Dual-Wheel Dual-Brake Elderly Driving Escort',
    titleTc: '雙軚盤雙剎車駕駛護航',
    tagEn: 'BC Licensed Instructor & Elderly Escort',
    tagTc: 'BC持牌駕駛導師護航',
    subtitleEn: 'Dual-Wheel Dual-Brake Elderly Driving Escort | BC Licensed Instructor',
    subtitleTc: '雙軚盤雙剎車駕駛護航 ｜ BC持牌駕駛導師護航',
    mottoTc: '香港人廣東話教車師傅，路面駕駛複習',
    descEn: 'Accompanied by a licensed driving instructor and empathetic senior companion to learn and review Vancouver traffic regulations. Whether preparing for a road test or maintaining driving independence, our instructors cultivate safe habits while discreetly evaluating reaction times and coordination as part of holistic elderly support.',
  ...
  },
  {
    ...
    titleEn: 'Bilingual Medical Escort & Doctor Companion',
    titleTc: '醫療陪診與即時翻譯',
    tagEn: 'Bilingual Medical Escort with Cantonese Translation',
    tagTc: '廣東話與英語雙語溝通',
    subtitleEn: 'Bilingual Medical Escort | Cantonese Medical Translation & Companion',
    subtitleTc: '醫療陪診與即時翻譯 ｜ 廣東話與英語雙語溝通',
    mottoTc: '診所醫院陪同、現場醫患雙語翻譯、診後紀錄整理',
    descEn: 'Comprehensive bilingual medical escort for specialist visits, walk-in clinics, hospitals, and lab tests. Includes door-to-door transportation, line waiting, live Cantonese medical translation between elders and English-speaking doctors, and converting physician instructions into organized family reports.',
    ...
    detailsEn: [
      ...
      'Fluent Cantonese medical translation and two-way doctor communication',
  ...
  },
  {
    ...
    titleEn: 'Grocery & Meal Prep Elderly Support',
    titleTc: '採購與食材備餐',
    tagEn: 'Grocery Companion & Meal Prep Support',
    tagTc: '購物代提，備料煮飯',
    subtitleEn: 'Grocery & Meal Prep Elderly Support | Companion Porter',
    subtitleTc: '採購與食材備餐 ｜ 購物代提，備料煮飯',
    mottoTc: '到 Richmond / 麗晶廣場採購新鮮食材，替長者搬運重物',
    descEn: 'Attentive elderly support accompanying parents to Asian markets like T&T or Crystal Mall (麗晶廣場) in Richmond & Burnaby. Handling heavy rice sacks and beverage cases, followed by washing, chopping, and portioning fresh ingredients.',
  ...
  },
  {
    id: 'home-assistance',
    iconName: 'Home',
    titleEn: 'Light Home Maintenance & Elderly Support',
    titleTc: '家居維護支援',
    tagEn: 'Repairs, Heavy Lifting, Replacement & Organizing',
    tagTc: '日常的修補、提重、更換、整理',
    subtitleEn: 'Light Home Maintenance & Elderly Support | Daily Repairs & Organizing',
    subtitleTc: '家居維護支援 ｜ 日常的修補、提重、更換、整理',
    mottoTc: '高空換燈泡、搬運重物家具、季節性防凍檢視、長者家居安全預防',
    descEn: 'Empathetic home assistance helping seniors change high-ceiling lightbulbs, move heavy seasonal furniture, conduct winterization visual checks, and remove household hazards for proactive elderly support.',
  ...
  },
  {
    id: 'tech-companion',
    iconName: 'Smartphone',
    titleEn: 'Tech Companion & Senior Communication Escort',
    titleTc: '科技伴讀與跨海連線',
    ...
    descEn: 'Patiently teaching seniors to master iPhone/iPad technology, setting large fonts and quick shortcuts, practicing video call connection with overseas family, setting up Hong Kong streaming, and guiding ride-hailing apps.',
...
export const PRICING_TEXT = {
  ...
  titleEn: 'Transparent Pricing · Overseas Peace of Mind · Dignified Elderly Escort',
  titleTc: '透明收費 · 孝心代達 · 尊嚴隨行 · 隔空掌舵',
  subtitleEn: 'Translating your long-distance love into a dignified senior companion service. Immediate post-session reporting keeps you seamlessly connected to your parents\' state from afar.',
...
export const FOOTER_TEXT = {
  ...
  subTitleEn: 'Boutique Bilingual Senior Concierge, Medical Escort & Elderly Companion in Greater Vancouver.',
